...
def menu_dev():
	...
	pil_kon = []
	print "\n"
	belum_premium = a+" ["+p+"@"+a+"] "+h+"UNLIMITED 😎"
	print baner
	...
	print garis
	pil = raw_input("[?] pilih mana?: ")
	pilihan(pil)
_uyuk_()
baner = """
.__  """+h+"""+{ I G E H }+"""+a+""" __________  _____      _____ _____________________
\______   \/  _  \    /     \\______   \_   _____/  Premium
 |     ___/  /_\  \  /  \ /  \|    |  _/|    __)   Ardinal
 |    |  /    |    \/    Y    \    |   \|     \    Instagram
 |____|  \____|__  /\____|__  /______  /\___  /    
                 \/         \/       \/     \/         
	"""
